...
address: "Mt Albert Science Centre, Auckland, New Zealand"  # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-41.147993,174.8368063"     # decimal latitude and longitude of workshop venue 
                                     # (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Jenny Draper", "Anthony Shaw"]   # boxed, comma-separated list of instructors' names as strings
helper: ["Janet Stacey", "Kim Nguyen"]              # boxed, comma-separated list of helpers' names
...
<p id="collaborative_notes">
  <strong>We will use this <a href="https://pad.carpentries.org/MASC_DC_workshop">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.</strong>
</p>
{% endif %}
